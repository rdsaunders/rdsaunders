...
* As a team we’ve been cooking a meal together at each review. This time around we had [Asian Salmon](), green Beans and store fried kale with garlic and chilli.
...
* Made efforts to start documenting our design system, taking cues from [Atlassian](), [Saleforce]() as well as material design to bring some structure to our component documents. I’ve leant on the familiar [MKDocs]() to give me a visual framework to work with until we can get Storybook working in the way we expect.
